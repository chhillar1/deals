...
/**
 * Plugin Name: Deals
 * Plugin URI: https://in.linkedin.com/in/praveenchhillar
 * Description: The very first plugin that I have ever created.
 * Version: 1.0.0
 * Author: Parveen Chhillar
 * Author URI: https://in.linkedin.com/in/praveenchhillar
 */
...
/**
 * Register post type  deals
 */
add_action( 'init', 'post_type_deals' );
function post_type_deals() {
	/**
	 * Admin only includes.
	 */
	if ( is_admin() ) {			
...
add_action('admin_menu' , 'settin_deals');
function settin_deals() {
